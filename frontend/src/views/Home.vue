<template>
  <div class="main-container">
    <div class="page-header">
      <h1>PDF处理工具</h1>
      <p>一站式在线PDF解决方案 - 合并、拆分、压缩、转换、水印等</p>
    </div>
...
const tools = [
  { 
    ...
    description: '将多个PDF文件合并为一个PDF，支持拖拽排序'
  },
  { 
    name: 'PDF拆分', 
    path: '/split', 
  ...
  { 
    ...
    description: '将PDF页面转换为PNG或JPG图片'
  },
  { 
    name: '图片转PDF', 
    path: '/from-image', 
  ...
  { 
    ...
    description: '删除、旋转、提取、重新排序PDF页面'
  },
  { 
    name: '历史记录', 
    path: '/history', 
